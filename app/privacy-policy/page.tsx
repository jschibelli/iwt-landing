  ...
  return (
    <main className="bg-[#0a2236] min-h-screen text-white py-12 px-4">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-4xl font-bold mb-8 text-teal-400">Privacy Policy</h1>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-2 text-white">3. How We Use Your Information</h2>
          <ul className="list-disc list-inside text-teal-100 space-y-2">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-2 text-white">4. Cookies and Tracking Technologies</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-2 text-white">5. Third-Party Services</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-2 text-white">6. Data Security</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-2 text-white">7. Your Data Protection Rights</h2>
          <ul className="list-disc list-inside text-teal-100 space-y-2">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-2 text-white">8. Children's Privacy</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-2 text-white">9. Changes to This Privacy Policy</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-2 text-white">10. Contact Us</h2>
