    ...
    <main className="bg-gray-900 text-white min-h-screen">
      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-teal-500 via-blue-500 to-indigo-600 text-white text-center">
        <div className="max-w-3xl mx-auto px-4">
          <h1 className="text-4xl md:text-6xl font-heading font-bold mb-4">Our Proven Process</h1>
          <p className="text-lg md:text-2xl font-body mb-6 text-white/90">From discovery to support, we guide you every step of the way to digital success.</p>
        </div>
      </section>
