  ...
  return (
    <main className="bg-[#0a2236] min-h-screen text-white py-12 px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-2 text-white">2. Use of the Site</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-2 text-white">3. Intellectual Property</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-2 text-white">4. User Obligations</h2>
          <ul className="list-disc list-inside text-teal-100 space-y-2">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-2 text-white">5. Disclaimers</h2>
          <ul className="list-disc list-inside text-teal-100 space-y-2">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-2 text-white">6. Limitation of Liability</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-2 text-white">7. Changes to Terms</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold mb-2 text-white">8. Governing Law</h2>
